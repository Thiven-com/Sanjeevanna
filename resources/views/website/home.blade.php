...
@section('content')
				...
				<div class="slide">
					...
					<div class="auto-container">
						<div class="content">
							...
							<div class="btns-box">
								<a href="{{ route('service') }}" class="theme-btn btn-style-one"><span class="txt">Know
										more</span></a>
							</div>
						</div>
					</div>
		...
		<div class="outer-container">
			...
			<div class="sortable-masonry">
				...
				<div class="items-container row clearfix">
					...
					<!-- Gallery Item -->
					<div class="gallery-item small-block masonry-item all residential office hospital commercial">
						<div class="inner-box">
							<figure class="image-box">
			...
			<div class="row clearfix">
				...
				<div class="feature-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<h3><a href="#">Trusted Services</a></h3>
							<div class="text">
								We provide reliable renovation and interior solutions with quality workmanship and timely
								completion.
							</div>
						</div>
					</div>
	...
	<section class="call-to-action-section"
		style="background-image:url('{{ asset('website/images/background/1-1.jpg') }}');background-size:cover;background-position:center;background-repeat:no-repeat;position:relative;min-height:660px;display:flex;align-items:center;padding:70px 0;">
		...
		<div class="auto-container" style="position:relative;z-index:1;width:100%;">
			...
			<div style="max-width:850px;transform:translateY(-35px);">
				...
				<h2
					style="color:#fff;font-size:52px;line-height:1.12;font-weight:700;max-width:900px;margin:0 0 30px;letter-spacing:-1px;">
					Think Renovation. Think Sanjeevanna &amp; Company
				</h2>

				<div
					style="width:620px;max-width:100%;padding:25px 30px;margin-bottom:32px;background:rgba(0,0,0,0.58);border:1px solid rgba(255,255,255,0.35);box-shadow:0 10px 30px rgba(0,0,0,0.25);">
